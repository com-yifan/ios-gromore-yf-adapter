...
#define gromore_splash_ID                 @"103446969" //聚合开屏广告位（BUSplashAd）

#define gromore_newInterstitial_ID        @"103444895" //聚合插全屏广告位（BUNativeExpressFullscreenVideoAd）

#define gromore_feed_ID                   @"103447060" //聚合feed广告位，用于测试模版 （BUNativeAdsManager）

#define gromore_reward_ID                 @"103447108" //聚合激励视频广告位（BURewardedVideoAd && BUNativeExpressRewardedVideoAd）

#define gromore_banner_ID                 @"103447605" //聚合banner广告位 （BUNativeExpressBannerView）
